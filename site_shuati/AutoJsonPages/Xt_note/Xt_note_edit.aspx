<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xt_note_edit.aspx.cs" Inherits="AutoJsonPages_Xt_note_Add" %>
...
<div class="modal-body note-modal-b">
    <div class="col-xs-12 notice-board">
        <form class="form-horizontal" method="post" action="/AutoJsonPages/Xt_note/Xt_note_json.aspx?act=edit" data-ajax="true" data-check="C.savenote">
            <div class="form-group">
                <label class="control-label">公告名称：</label>
                <input class="rele-com-inp" name="Title" placeholder="公告名称" value="<%=result1._Title %>" />
                <input type="hidden" name="Uuid" value="<%=result1._Uuid %>">
           ...
           <div class="form-group">
                <%--
                <div  >
                    <label class="control-label">选择添加到班级：</label>                
