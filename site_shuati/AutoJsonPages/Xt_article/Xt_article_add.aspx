<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xt_article_add.aspx.cs" Inherits="AutoJsonPages_Xt_task_Xt_task_add"  %>
...
<head>
    ...
    <script type="text/javascript">
        (function () {
            var C = window.C = { UID: 560346, ROOT: "", APP: "", PUBLIC: "/Public", STATIC_URL: "http://static.ibodao.com", DEEP: "/", MODEL: ["2", "", "html"], VAR: ["m", "c", "a"] }
        })();
    </script>
        ...
        <div class="row center-block left_nav  J_left_nav">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav c-nav">
                    ...
                    <li><a href="http://bbs.ibodao.com/" target="_blank">社区</a></li>
    ...
    <div class="container-fluid  c-footer">
        <div class="row center-block center">
            <div class="col-md-9">
                ...
                <p>
                    Copyright &copy; 2013-2017 ibodao.com All Rights Reserved |  <a class="i-beian" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802022973" target="_blank"><i></i>京公网安备11010802022973号</a>
            ...
            <div class="col-md-3">
                <div class="text-right c-icon-nav">
                    ...
                    <a href="http://weibo.com/bdibodao" target='_blank'><i class="icon icon-xinlang"></i></a>
                    <a href="http://wpa.qq.com/msgrd?v=3&uin=2918450351&site=qq&menu=yes" target='_blank'><i class="icon icon-qq"></i></a>
                </div>
            </div>
        </div>
    </div>
    <div class="c-right-tool hide">
        <a class="feed-back hide" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2918450351&site=qq&menu=yes" title="请给出您宝贵的意见">
