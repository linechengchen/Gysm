<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xt_task_edit.aspx.cs" Inherits="AutoJsonPages_Xt_task_Xt_task_add"  %>
		...
		<div class="release-cont row">
			...
			<div id="rele-basic" class="rele-tag-body release-c">
				<div class="rele-com-board">
					...
					<input class="rele-com-inp" type="text"  value="<%=val1.Title %>"name="name" id="name">
