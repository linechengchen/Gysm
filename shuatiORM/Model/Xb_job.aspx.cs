...
//将Xb_job 批量查找替换成其他实体类，即可实现json接口we
#region 接口说明
...
public partial class AutoJsonPages_xb_getuser : BasePageShuati
{
    ...
    #region 输入输出参数
    Xb_job param1 = new Xb_job();//输入条件参数
    ...
    #region 上传插入图片
    static string ImgFileUploadPath = @"E:\工程项目\刷题神器\小程序微信接口\Headimg_Xb_job\";
