/************************************************************
  ...
  Description:    数据表Xb_comment_item对应的业务逻辑层Xb_comment_item
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Xb_comment_item_Entity:Xb_comment_item
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para></para>
    /// <para>与Xb_comment_item数据表对应的实体对象。</para>
    ...
    public class Xb_comment_item : ITableImplement
    {
        ...
        {
            return (Xb_comment_item)this.MemberwiseClone(); //浅复制
        }
        #endregion
