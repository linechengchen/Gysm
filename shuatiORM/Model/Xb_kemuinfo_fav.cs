/************************************************************
  ...
  Description:    数据表Xb_kemuinfo_fav对应的业务逻辑层Xb_kemuinfo_fav
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Xb_kemuinfo_fav_Entity:Xb_kemuinfo_fav
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para></para>
    /// <para>与Xb_kemuinfo_fav数据表对应的实体对象。</para>
    ...
    public class Xb_kemuinfo_fav : ITableImplement
    {
        ...
        /// <summary> 科目身份:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        public int _Kemu_id
        {            
        ...
        /// <summary> 科目身份:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        public int Kemu_id
        {
        ...
        public class Attribute
        {
            ...
            /// <summary>科目身份:[CtrlTypeDic-{InputString}]</summary>
        ...
        {
            return (Xb_kemuinfo_fav)this.MemberwiseClone(); //浅复制
        }
        #endregion
