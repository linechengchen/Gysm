/************************************************************
  ...
  Author:               Created Time: 2017/7/7 17:19:37
  Description:    数据表St_Paper233对应的业务逻辑层St_Paper233
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 St_Paper233_Entity:St_Paper233
 * 
************************************************************/
/************************************************************
SQL代码：
select AutoId,AddTime,ClassId,ClickNum,Id,PaperName,PaperStatus,ProblemCount,RecTf,RightProblemCount,Url from St_Paper233
delete from St_Paper233
INSERT INTO St_Paper233 (AutoId,AddTime,ClassId,ClickNum,Id,PaperName,PaperStatus,ProblemCount,RecTf,RightProblemCount,Url)
     VALUES
           ('','','','','','','','','','','')
UPDATE St_Paper233 SET ...
变量赋值代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para>试卷233</para>
    /// <para>与St_Paper233数据表对应的实体对象。</para>
    /// <para>增加一个数据列的方法是：在"类字段"节增加一个bool标识位，与"Attribute"属性 </para>
    /// </summary>    
    [Serializable]
    public class St_Paper233 : ITableImplement
    {
        /// <summary>工厂方法  </summary>
        public static St_Paper233 Factory()
        {
            return new St_Paper233();
        }
        ...
        public class Attribute
        {
            ...
            public static AttributeItem AutoId =  new AttributeItem("[St_Paper233].[AutoId]", typeof(int), 4, default(int));
            
            /// <summary>添加时间:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem AddTime =  new AttributeItem("[St_Paper233].[AddTime]", typeof(string), 200, default(string));
            
            /// <summary>科目ID:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ClassId =  new AttributeItem("[St_Paper233].[ClassId]", typeof(string), 200, default(string));
            
            /// <summary>点击次数:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ClickNum =  new AttributeItem("[St_Paper233].[ClickNum]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Id =  new AttributeItem("[St_Paper233].[Id]", typeof(string), 200, default(string));
            
            /// <summary>试卷名:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem PaperName =  new AttributeItem("[St_Paper233].[PaperName]", typeof(string), 200, default(string));
            
            /// <summary>试题状态:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem PaperStatus =  new AttributeItem("[St_Paper233].[PaperStatus]", typeof(string), 200, default(string));
            
            /// <summary>题目总数:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ProblemCount =  new AttributeItem("[St_Paper233].[ProblemCount]", typeof(string), 200, default(string));
            
            /// <summary>是否回顾:[Enum-{0:是},{1:否}][CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem RecTf =  new AttributeItem("[St_Paper233].[RecTf]", typeof(string), 200, default(string));
            
            /// <summary>判断题总数:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem RightProblemCount =  new AttributeItem("[St_Paper233].[RightProblemCount]", typeof(string), 200, default(string));
            
            /// <summary>链接地址:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Url =  new AttributeItem("[St_Paper233].[Url]", typeof(string), 200, default(string));
        }
        #endregion
        #region bool清单 辅助设计
        ...
        /// <summary></summary>
        public new St_Paper233 Clone()
        {
            return (St_Paper233)this.MemberwiseClone(); //浅复制
        }
        #endregion
        ...
        public St_Paper233(bool IsLoadAllAttributes):base(IsLoadAllAttributes) { }
        /// <summary>实现分表功能，修改表名  </summary>
        //public St_Paper233(string tableName):base(tableName) { }
        /// <summary>实现分表功能，自定义实例的初始化  </summary>
        //public St_Paper233(string tableName, params AttributeItem[] attrs) : base(tableName, attrs) { }
        /// <summary>实现快捷功能  </summary>
        //public St_Paper233(params AttributeItem[] attrs) : base(attrs) { }
        
        /// <summary>请注意，这里当表中仅存在一个字段的时候，将可能与构造函数 new Table(string tableName)冲突  </summary>
        public St_Paper233(int autoid1, string addtime1, string classid1, string clicknum1, string id1, string papername1, string paperstatus1, string problemcount1, string rectf1, string rightproblemcount1, string url1)
        {
        ...
        public static St_Paper233 FromIView(IView view)
        {
            return (St_Paper233)IView.GetITable(view, "St_Paper233");
        }
        ...
        public St_Paper233 Retrieve()
        {
            BLLTable<St_Paper233>.GetRowData(this);
            return this;
        }
        #endregion
        ...
        public override AttributeItem[] af_GetAvailableAttributeItem(ref List<object> values)
        {
			...
			{
                AttributeItem attr = St_Paper233.Attribute.AutoId;
			...
			{
                AttributeItem attr = St_Paper233.Attribute.AddTime;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_Paper233.Attribute.ClassId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_Paper233.Attribute.ClickNum;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (id_initialized)
			{
                AttributeItem attr = St_Paper233.Attribute.Id;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_Paper233.Attribute.PaperName;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_Paper233.Attribute.PaperStatus;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_Paper233.Attribute.ProblemCount;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_Paper233.Attribute.RecTf;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_Paper233.Attribute.RightProblemCount;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (url_initialized)
			{
                AttributeItem attr = St_Paper233.Attribute.Url;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
