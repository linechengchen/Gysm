/************************************************************
  ...
  Author:               Created Time: 2017/6/13 13:51:05
  Description:    数据表St_TTimuDaXue_ShowAll对应的业务逻辑层St_TTimuDaXue_ShowAll
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 St_TTimuDaXue_ShowAll_Entity:St_TTimuDaXue_ShowAll
 * 
************************************************************/
/************************************************************
SQL代码：
select AutoId,Analysis,Answer,AnswerABC,Area,ChapterId,ChapterName,Difficulty,DiggDown,DiggUp,ExamType,Explain,FalseCount,Id,IsRepeatTf,KaoDian,Kemu,KemuId,Knowledge,Label,LinkExam,MediaContent,MediaHeight,MediaType,MediaWidth,OptionA,OptionB,OptionC,OptionD,OptionE,OptionF,OptionG,OptionH,Optionnum,OptionStr,OptionType,OrderId,PaperShortName,Question,QuestionId,QuestionIndex,Sc,Score,SourceFile,Sourceid,SourceZhangjie,Teacher,TrueCount,Url,User_id,WrongRate,YearId from St_TTimuDaXue_ShowAll
delete from St_TTimuDaXue_ShowAll
INSERT INTO St_TTimuDaXue_ShowAll (AutoId,Analysis,Answer,AnswerABC,Area,ChapterId,ChapterName,Difficulty,DiggDown,DiggUp,ExamType,Explain,FalseCount,Id,IsRepeatTf,KaoDian,Kemu,KemuId,Knowledge,Label,LinkExam,MediaContent,MediaHeight,MediaType,MediaWidth,OptionA,OptionB,OptionC,OptionD,OptionE,OptionF,OptionG,OptionH,Optionnum,OptionStr,OptionType,OrderId,PaperShortName,Question,QuestionId,QuestionIndex,Sc,Score,SourceFile,Sourceid,SourceZhangjie,Teacher,TrueCount,Url,User_id,WrongRate,YearId)
     VALUES
           ('','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','')
UPDATE St_TTimuDaXue_ShowAll SET ...
变量赋值代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    ...
    /// <para>与St_TTimuDaXue_ShowAll数据表对应的实体对象。</para>
    /// <para>增加一个数据列的方法是：在"类字段"节增加一个bool标识位，与"Attribute"属性 </para>
    /// </summary>    
    [Serializable]
    public class St_TTimuDaXue_ShowAll : ITableImplement
    {
        /// <summary>工厂方法  </summary>
        public static St_TTimuDaXue_ShowAll Factory()
        {
            return new St_TTimuDaXue_ShowAll();
        }
        ...
        public class Attribute
        {
            ...
            public static AttributeItem AutoId =  new AttributeItem("[St_TTimuDaXue_ShowAll].[AutoId]", typeof(int), 4, default(int));
            
            /// <summary>考题分析:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Analysis =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Analysis]", typeof(string), 50, default(string));
            
            /// <summary>答案:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Answer =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Answer]", typeof(string), -1, default(string));
            
            /// <summary>学生提交的纠错答案:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem AnswerABC =  new AttributeItem("[St_TTimuDaXue_ShowAll].[AnswerABC]", typeof(string), 50, default(string));
            
            /// <summary>地区:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Area =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Area]", typeof(string), 50, default(string));
            
            /// <summary>章节编号:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ChapterId =  new AttributeItem("[St_TTimuDaXue_ShowAll].[ChapterId]", typeof(string), 30, default(string));
            
            /// <summary>章节编号:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ChapterName =  new AttributeItem("[St_TTimuDaXue_ShowAll].[ChapterName]", typeof(string), 100, default(string));
            
            /// <summary>难易程序:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Difficulty =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Difficulty]", typeof(string), 200, default(string));
            
            /// <summary>差评:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem DiggDown =  new AttributeItem("[St_TTimuDaXue_ShowAll].[DiggDown]", typeof(string), 50, default(string));
            
            /// <summary>好评:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem DiggUp =  new AttributeItem("[St_TTimuDaXue_ShowAll].[DiggUp]", typeof(string), 50, default(string));
            
            /// <summary>试卷类型:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ExamType =  new AttributeItem("[St_TTimuDaXue_ShowAll].[ExamType]", typeof(string), 50, default(string));
            
            /// <summary>试题解析:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Explain =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Explain]", typeof(string), 2000, default(string));
            
            /// <summary>错误次数:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem FalseCount =  new AttributeItem("[St_TTimuDaXue_ShowAll].[FalseCount]", typeof(string), 200, default(string));
            
            /// <summary>采集编号:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Id =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Id]", typeof(int), 4, default(int));
            
            /// <summary>是否重做(0是1否):[Enum-{0:是},{1:否}][CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem IsRepeatTf =  new AttributeItem("[St_TTimuDaXue_ShowAll].[IsRepeatTf]", typeof(int), 4, default(int));
            
            /// <summary>考点:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem KaoDian =  new AttributeItem("[St_TTimuDaXue_ShowAll].[KaoDian]", typeof(string), 200, default(string));
            
            /// <summary>科目:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Kemu =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Kemu]", typeof(string), 200, default(string));
            
            /// <summary>科目Id:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem KemuId =  new AttributeItem("[St_TTimuDaXue_ShowAll].[KemuId]", typeof(int), 4, default(int));
            
            /// <summary>考点:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Knowledge =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Knowledge]", typeof(string), 50, default(string));
            
            /// <summary>章节:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Label =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Label]", typeof(string), 100, default(string));
            
            /// <summary>大题题号:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem LinkExam =  new AttributeItem("[St_TTimuDaXue_ShowAll].[LinkExam]", typeof(string), 50, default(string));
            
            /// <summary>媒体内容:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaContent =  new AttributeItem("[St_TTimuDaXue_ShowAll].[MediaContent]", typeof(string), 200, default(string));
            
            /// <summary>媒体高度:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaHeight =  new AttributeItem("[St_TTimuDaXue_ShowAll].[MediaHeight]", typeof(string), 100, default(string));
            
            /// <summary>媒体类型:[Enum-{0:"文字"},{1:"图片"},{2:"视频"}][CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaType =  new AttributeItem("[St_TTimuDaXue_ShowAll].[MediaType]", typeof(string), 200, default(string));
            
            /// <summary>媒体宽度:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaWidth =  new AttributeItem("[St_TTimuDaXue_ShowAll].[MediaWidth]", typeof(string), 200, default(string));
            
            /// <summary>A:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionA =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionA]", typeof(string), 200, default(string));
            
            /// <summary>B:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionB =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionB]", typeof(string), 200, default(string));
            
            /// <summary>C:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionC =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionC]", typeof(string), 200, default(string));
            
            /// <summary>D:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionD =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionD]", typeof(string), 200, default(string));
            
            /// <summary>E:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionE =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionE]", typeof(string), 200, default(string));
            
            /// <summary>F:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionF =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionF]", typeof(string), 200, default(string));
            
            /// <summary>G:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionG =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionG]", typeof(string), 200, default(string));
            
            /// <summary>H:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionH =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionH]", typeof(string), 200, default(string));
            
            /// <summary>多选题答案个数:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Optionnum =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Optionnum]", typeof(string), 200, default(string));
            
            /// <summary>选项字符串-用竖线分隔符:[CtrlTypeDic-{HTML}]</summary>
            public static AttributeItem OptionStr =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionStr]", typeof(string), 3000, default(string));
            
            /// <summary>题型-:[Enum-{0:单选},{1:多选},{2:判断},{3:简答论述},{4:不定项选择},{5:填空},{6:词汇},{7:图文题}][CtrlTypeDic-{SelectDrop}]</summary>
            public static AttributeItem OptionType =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OptionType]", typeof(string), 20, default(string));
            
            /// <summary>顺序号:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OrderId =  new AttributeItem("[St_TTimuDaXue_ShowAll].[OrderId]", typeof(string), 50, default(string));
            
            /// <summary>试卷简称:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem PaperShortName =  new AttributeItem("[St_TTimuDaXue_ShowAll].[PaperShortName]", typeof(string), 50, default(string));
            
            /// <summary>题目:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Question =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Question]", typeof(string), -1, default(string));
            
            /// <summary>题号:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem QuestionId =  new AttributeItem("[St_TTimuDaXue_ShowAll].[QuestionId]", typeof(int), 4, default(int));
            
            /// <summary>题目顺序号:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem QuestionIndex =  new AttributeItem("[St_TTimuDaXue_ShowAll].[QuestionIndex]", typeof(int), 4, default(int));
            
            /// <summary>源大学微信号:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Sc =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Sc]", typeof(string), 20, default(string));
            
            /// <summary>分值:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Score =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Score]", typeof(string), 10, default(string));
            
            /// <summary>源文件:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem SourceFile =  new AttributeItem("[St_TTimuDaXue_ShowAll].[SourceFile]", typeof(string), 200, default(string));
            
            /// <summary>源ID:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Sourceid =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Sourceid]", typeof(string), 200, default(string));
            
            /// <summary>源章节:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem SourceZhangjie =  new AttributeItem("[St_TTimuDaXue_ShowAll].[SourceZhangjie]", typeof(string), 200, default(string));
            
            /// <summary>出题老师:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Teacher =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Teacher]", typeof(string), 50, default(string));
            
            /// <summary>正确次数:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem TrueCount =  new AttributeItem("[St_TTimuDaXue_ShowAll].[TrueCount]", typeof(string), 200, default(string));
            
            /// <summary>链接地址:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Url =  new AttributeItem("[St_TTimuDaXue_ShowAll].[Url]", typeof(string), 200, default(string));
            
            /// <summary>用户Id:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem User_id =  new AttributeItem("[St_TTimuDaXue_ShowAll].[User_id]", typeof(string), 36, default(string));
            
            /// <summary>错误率:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem WrongRate =  new AttributeItem("[St_TTimuDaXue_ShowAll].[WrongRate]", typeof(string), 200, default(string));
            
            /// <summary>试卷年份:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem YearId =  new AttributeItem("[St_TTimuDaXue_ShowAll].[YearId]", typeof(string), 50, default(string));
        }
        #endregion
        #region bool清单 辅助设计
		...
		{ 
			St_TTimuDaXue_ShowAll value = new St_TTimuDaXue_ShowAll();
        ...
        public static St_TTimuDaXue_ShowAll FromIView(IView view)
        {
            return (St_TTimuDaXue_ShowAll)IView.GetITable(view, "St_TTimuDaXue_ShowAll");
        }
        /// <summary>获得一个实例  </summary>
        public static St_TTimuDaXue_ShowAll GetOneInstance()
        {
            St_TTimuDaXue_ShowAll value = new St_TTimuDaXue_ShowAll();
            return value;
        }
        /// <summary>获取单一实例==BLLTable.GetRowData(); </summary>
        public St_TTimuDaXue_ShowAll Retrieve()
        {
            BLLTable<St_TTimuDaXue_ShowAll>.GetRowData(this);
            return this;
        }
        #endregion
        ...
        public override AttributeItem[] af_GetAvailableAttributeItem(ref List<object> values)
        {
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.AutoId;
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Analysis;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Answer;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.AnswerABC;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (area_initialized)
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Area;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.ChapterId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.ChapterName;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Difficulty;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.DiggDown;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.DiggUp;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.ExamType;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Explain;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.FalseCount;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (id_initialized)
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Id;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.IsRepeatTf;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.KaoDian;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (kemu_initialized)
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Kemu;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.KemuId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Knowledge;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Label;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.LinkExam;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.MediaContent;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.MediaHeight;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.MediaType;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.MediaWidth;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionA;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionB;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionC;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionD;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionE;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionF;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionG;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionH;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Optionnum;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionStr;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OptionType;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.OrderId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.PaperShortName;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Question;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.QuestionId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.QuestionIndex;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (sc_initialized)
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Sc;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Score;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.SourceFile;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Sourceid;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.SourceZhangjie;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Teacher;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.TrueCount;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (url_initialized)
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.Url;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.User_id;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.WrongRate;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = St_TTimuDaXue_ShowAll.Attribute.YearId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
        ...
        /// </summary>
        [Serializable]
        public class St_TTimuDaXue_ShowAllJson
        {
