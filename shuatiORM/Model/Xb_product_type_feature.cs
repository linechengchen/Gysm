...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    ...
    public class Xb_product_type_feature : ITableImplement
    {
        ...
        /// <summary> 描述标题:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 描述内容:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 套餐类型id:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 描述标题:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        public string Items
        {
        ...
        /// <summary> 描述内容:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 套餐类型id:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        public class Attribute
        {
            ...
            /// <summary>描述标题:[CtrlTypeDic-{InputString}]</summary>
            ...
            /// <summary>描述内容:[CtrlTypeDic-{InputString}]</summary>
            ...
            /// <summary>套餐类型id:[CtrlTypeDic-{InputString}]</summary>
