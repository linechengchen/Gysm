/************************************************************
  ...
  Author:               Created Time: 2017/8/4 16:40:18
  Description:    数据表V_teacher_user对应的业务逻辑层V_teacher_user
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 V_teacher_user_Entity:V_teacher_user
 * 
************************************************************/
/************************************************************
SQL代码：
select Expr1,Teacher_uuid,Jiaoyuan_category,Pay_jine,Pay_keshi,Pay_category,Uuid,Id,Experience_year,College,College_major,Work_field,Recommend,Voice,Introduce,Introduce_en,Photo,Wx_head_img,Score_high_school,Score_mianshi1,Score_mianshi2,Score_mianshi3,Score_mianshi,Teacher_name_en,Teacher_name,Jin_sex,Phone_number,Born,High_school,Good_at,Experience,Experience_intro,Work_area,Home_area,Other_area,Create_time,Wx_nick_name,Wx_sex,Wx_country,Wx_province,Wx_city,F26,F27,OpenID,Wx_create_man,Wx_post_time,Wx_modify_time,Wx_device,Wx_os,Wx_explore,IP,Is_show,On_top,On_top_timeout,Time_match_ids,Has_time_match_ids,Today_match_ids,Has_today_match_ids,Catelog,Teacher_type,English_kemu,Teach_exp,Teacher_mode,Service_type,Sex,Kemu,City_id,Is_recommend,Is_done,Score_seq,Type,E_wei_ma,Grade,Grade1,Grade2,Xuebapingyu,Weizhi,QQnum,ShujiaTime,Good_kemu,Good_nianji,Ke_jieshou_kaishiTime,Ke_jieshou_jiesuTime,User_id from V_teacher_user
delete from V_teacher_user
INSERT INTO V_teacher_user (Expr1,Teacher_uuid,Jiaoyuan_category,Pay_jine,Pay_keshi,Pay_category,Uuid,Id,Experience_year,College,College_major,Work_field,Recommend,Voice,Introduce,Introduce_en,Photo,Wx_head_img,Score_high_school,Score_mianshi1,Score_mianshi2,Score_mianshi3,Score_mianshi,Teacher_name_en,Teacher_name,Jin_sex,Phone_number,Born,High_school,Good_at,Experience,Experience_intro,Work_area,Home_area,Other_area,Create_time,Wx_nick_name,Wx_sex,Wx_country,Wx_province,Wx_city,F26,F27,OpenID,Wx_create_man,Wx_post_time,Wx_modify_time,Wx_device,Wx_os,Wx_explore,IP,Is_show,On_top,On_top_timeout,Time_match_ids,Has_time_match_ids,Today_match_ids,Has_today_match_ids,Catelog,Teacher_type,English_kemu,Teach_exp,Teacher_mode,Service_type,Sex,Kemu,City_id,Is_recommend,Is_done,Score_seq,Type,E_wei_ma,Grade,Grade1,Grade2,Xuebapingyu,Weizhi,QQnum,ShujiaTime,Good_kemu,Good_nianji,Ke_jieshou_kaishiTime,Ke_jieshou_jiesuTime,User_id)
     VALUES
           ('','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','')
UPDATE V_teacher_user SET ...
变量赋值代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    ...
    /// <para>与V_teacher_user数据表对应的实体对象。</para>
    /// <para>增加一个数据列的方法是：在"类字段"节增加一个bool标识位，与"Attribute"属性 </para>
    /// </summary>    
    [Serializable]
    public class V_teacher_user : ITableImplement
    {
        /// <summary>工厂方法  </summary>
        public static V_teacher_user Factory()
        {
            return new V_teacher_user();
        }
        ...
        public class Attribute
        {
            ...
            /// <summary></summary>
            public static AttributeItem Expr1 =  new AttributeItem("[V_teacher_user].[Expr1]", typeof(Guid), 16, default(Guid));
            
            /// <summary></summary>
            public static AttributeItem Teacher_uuid =  new AttributeItem("[V_teacher_user].[Teacher_uuid]", typeof(string), 36, default(string));
            
            /// <summary>付款分类:[Enum-{0:试用期},{1:已签约}]</summary>
            public static AttributeItem Jiaoyuan_category =  new AttributeItem("[V_teacher_user].[Jiaoyuan_category]", typeof(int), 4, default(int));
            
            /// <summary></summary>
            public static AttributeItem Pay_jine =  new AttributeItem("[V_teacher_user].[Pay_jine]", typeof(int), 4, default(int));
            
            /// <summary></summary>
            public static AttributeItem Pay_keshi =  new AttributeItem("[V_teacher_user].[Pay_keshi]", typeof(int), 4, default(int));
            
            /// <summary>付款分类:[Enum-{0:月付},{1:季付},{2:学期付},{3:年付}]</summary>
            public static AttributeItem Pay_category =  new AttributeItem("[V_teacher_user].[Pay_category]", typeof(int), 4, default(int));
            
            /// <summary></summary>
            public static AttributeItem Uuid =  new AttributeItem("[V_teacher_user].[Uuid]", typeof(Guid), 16, default(Guid));
            
            /// <summary></summary>
            public static AttributeItem Id =  new AttributeItem("[V_teacher_user].[Id]", typeof(int), 4, default(int));
            
            /// <summary>教课经验</summary>
            public static AttributeItem Experience_year =  new AttributeItem("[V_teacher_user].[Experience_year]", typeof(double), 8, default(double));
            
            /// <summary>大学</summary>
            public static AttributeItem College =  new AttributeItem("[V_teacher_user].[College]", typeof(string), 100, default(string));
            
            /// <summary>大学专业</summary>
            public static AttributeItem College_major =  new AttributeItem("[V_teacher_user].[College_major]", typeof(string), 100, default(string));
            
            /// <summary>工作行业</summary>
            public static AttributeItem Work_field =  new AttributeItem("[V_teacher_user].[Work_field]", typeof(string), 100, default(string));
            
            /// <summary>适合学员</summary>
            public static AttributeItem Recommend =  new AttributeItem("[V_teacher_user].[Recommend]", typeof(string), 100, default(string));
            
            /// <summary>语音介绍</summary>
            public static AttributeItem Voice =  new AttributeItem("[V_teacher_user].[Voice]", typeof(string), 300, default(string));
            
            /// <summary>自我简介</summary>
            public static AttributeItem Introduce =  new AttributeItem("[V_teacher_user].[Introduce]", typeof(string), 1500, default(string));
            
            /// <summary>英语自我介绍</summary>
            public static AttributeItem Introduce_en =  new AttributeItem("[V_teacher_user].[Introduce_en]", typeof(string), 3000, default(string));
            
            /// <summary>随身照</summary>
            public static AttributeItem Photo =  new AttributeItem("[V_teacher_user].[Photo]", typeof(string), 255, default(string));
            
            /// <summary>微信头像</summary>
            public static AttributeItem Wx_head_img =  new AttributeItem("[V_teacher_user].[Wx_head_img]", typeof(string), 255, default(string));
            
            /// <summary>高考成绩</summary>
            public static AttributeItem Score_high_school =  new AttributeItem("[V_teacher_user].[Score_high_school]", typeof(string), 1000, default(string));
            
            /// <summary>面试评分1-经验</summary>
            public static AttributeItem Score_mianshi1 =  new AttributeItem("[V_teacher_user].[Score_mianshi1]", typeof(string), 100, default(string));
            
            /// <summary>面试评分2-沟通</summary>
            public static AttributeItem Score_mianshi2 =  new AttributeItem("[V_teacher_user].[Score_mianshi2]", typeof(string), 100, default(string));
            
            /// <summary>面试评分3-技能</summary>
            public static AttributeItem Score_mianshi3 =  new AttributeItem("[V_teacher_user].[Score_mianshi3]", typeof(string), 100, default(string));
            
            /// <summary>面试总分</summary>
            public static AttributeItem Score_mianshi =  new AttributeItem("[V_teacher_user].[Score_mianshi]", typeof(string), 100, default(string));
            
            /// <summary>讲师英文名</summary>
            public static AttributeItem Teacher_name_en =  new AttributeItem("[V_teacher_user].[Teacher_name_en]", typeof(string), 100, default(string));
            
            /// <summary>讲师姓名</summary>
            public static AttributeItem Teacher_name =  new AttributeItem("[V_teacher_user].[Teacher_name]", typeof(string), 100, default(string));
            
            /// <summary>性别:[Enum-{:不限},{1:男老师},{2:女老师}]</summary>
            public static AttributeItem Jin_sex =  new AttributeItem("[V_teacher_user].[Jin_sex]", typeof(string), 50, default(string));
            
            /// <summary>手机号</summary>
            public static AttributeItem Phone_number =  new AttributeItem("[V_teacher_user].[Phone_number]", typeof(string), 100, default(string));
            
            /// <summary>出生年月日</summary>
            public static AttributeItem Born =  new AttributeItem("[V_teacher_user].[Born]", typeof(string), 100, default(string));
            
            /// <summary>高中学校是否重点</summary>
            public static AttributeItem High_school =  new AttributeItem("[V_teacher_user].[High_school]", typeof(string), 2000, default(string));
            
            /// <summary>擅长科目</summary>
            public static AttributeItem Good_at =  new AttributeItem("[V_teacher_user].[Good_at]", typeof(string), 2000, default(string));
            
            /// <summary>家教经验</summary>
            public static AttributeItem Experience =  new AttributeItem("[V_teacher_user].[Experience]", typeof(string), 2000, default(string));
            
            /// <summary>经验详细介绍</summary>
            public static AttributeItem Experience_intro =  new AttributeItem("[V_teacher_user].[Experience_intro]", typeof(string), 2000, default(string));
            
            /// <summary>意向工作区域</summary>
            public static AttributeItem Work_area =  new AttributeItem("[V_teacher_user].[Work_area]", typeof(string), 2000, default(string));
            
            /// <summary>家乡所在区域</summary>
            public static AttributeItem Home_area =  new AttributeItem("[V_teacher_user].[Home_area]", typeof(string), 2000, default(string));
            
            /// <summary>其他意向区域</summary>
            public static AttributeItem Other_area =  new AttributeItem("[V_teacher_user].[Other_area]", typeof(string), 2000, default(string));
            
            /// <summary>填写日期</summary>
            public static AttributeItem Create_time =  new AttributeItem("[V_teacher_user].[Create_time]", typeof(string), 255, default(string));
            
            /// <summary>微信昵称</summary>
            public static AttributeItem Wx_nick_name =  new AttributeItem("[V_teacher_user].[Wx_nick_name]", typeof(string), 255, default(string));
            
            /// <summary>微信性别:[Enum-{1:男},{2:女}]</summary>
            public static AttributeItem Wx_sex =  new AttributeItem("[V_teacher_user].[Wx_sex]", typeof(string), 255, default(string));
            
            /// <summary>微信国家</summary>
            public static AttributeItem Wx_country =  new AttributeItem("[V_teacher_user].[Wx_country]", typeof(string), 255, default(string));
            
            /// <summary>微信省市</summary>
            public static AttributeItem Wx_province =  new AttributeItem("[V_teacher_user].[Wx_province]", typeof(string), 255, default(string));
            
            /// <summary>微信市</summary>
            public static AttributeItem Wx_city =  new AttributeItem("[V_teacher_user].[Wx_city]", typeof(string), 255, default(string));
            
            /// <summary></summary>
            public static AttributeItem F26 =  new AttributeItem("[V_teacher_user].[F26]", typeof(string), 255, default(string));
            
            /// <summary></summary>
            public static AttributeItem F27 =  new AttributeItem("[V_teacher_user].[F27]", typeof(string), 255, default(string));
            
            /// <summary></summary>
            public static AttributeItem OpenID =  new AttributeItem("[V_teacher_user].[OpenID]", typeof(string), 255, default(string));
            
            /// <summary>提交人</summary>
            public static AttributeItem Wx_create_man =  new AttributeItem("[V_teacher_user].[Wx_create_man]", typeof(string), 255, default(string));
            
            /// <summary>提交时间</summary>
            public static AttributeItem Wx_post_time =  new AttributeItem("[V_teacher_user].[Wx_post_time]", typeof(string), 255, default(string));
            
            /// <summary>修改时间</summary>
            public static AttributeItem Wx_modify_time =  new AttributeItem("[V_teacher_user].[Wx_modify_time]", typeof(string), 255, default(string));
            
            /// <summary>填写设备</summary>
            public static AttributeItem Wx_device =  new AttributeItem("[V_teacher_user].[Wx_device]", typeof(string), 255, default(string));
            
            /// <summary>操作系统</summary>
            public static AttributeItem Wx_os =  new AttributeItem("[V_teacher_user].[Wx_os]", typeof(string), 255, default(string));
            
            /// <summary>浏览器</summary>
            public static AttributeItem Wx_explore =  new AttributeItem("[V_teacher_user].[Wx_explore]", typeof(string), 255, default(string));
            
            /// <summary>Ip地址</summary>
            public static AttributeItem IP =  new AttributeItem("[V_teacher_user].[IP]", typeof(string), 255, default(string));
            
            /// <summary>是否显示</summary>
            public static AttributeItem Is_show =  new AttributeItem("[V_teacher_user].[Is_show]", typeof(bool), 1, default(bool));
            
            /// <summary>是否置顶</summary>
            public static AttributeItem On_top =  new AttributeItem("[V_teacher_user].[On_top]", typeof(bool), 1, default(bool));
            
            /// <summary>置顶超时日期</summary>
            public static AttributeItem On_top_timeout =  new AttributeItem("[V_teacher_user].[On_top_timeout]", typeof(DateTime), 8, default(DateTime));
            
            /// <summary>课程时间(day_min，返回前端为当前天int值)</summary>
            public static AttributeItem Time_match_ids =  new AttributeItem("[V_teacher_user].[Time_match_ids]", typeof(string), -1, default(string));
            
            /// <summary>已被预约的课程时间(day_min，返回前端为当前天int值)</summary>
            public static AttributeItem Has_time_match_ids =  new AttributeItem("[V_teacher_user].[Has_time_match_ids]", typeof(string), -1, default(string));
            
            /// <summary>今日计算结果int</summary>
            public static AttributeItem Today_match_ids =  new AttributeItem("[V_teacher_user].[Today_match_ids]", typeof(string), 1000, default(string));
            
            /// <summary>今日已预约计算结果int</summary>
            public static AttributeItem Has_today_match_ids =  new AttributeItem("[V_teacher_user].[Has_today_match_ids]", typeof(string), 1000, default(string));
            
            /// <summary>Tab大类:[Enum-{0:优选教员},{1:外教},{2:小班课},{3:暑期课}]</summary>
            public static AttributeItem Catelog =  new AttributeItem("[V_teacher_user].[Catelog]", typeof(int), 4, default(int));
            
            /// <summary>讲师类型:[Enum-{0:不限},{1:留学生外教},{2:欧美外教}]</summary>
            public static AttributeItem Teacher_type =  new AttributeItem("[V_teacher_user].[Teacher_type]", typeof(int), 4, default(int));
            ...
            public static AttributeItem English_kemu =  new AttributeItem("[V_teacher_user].[English_kemu]", typeof(int), 4, default(int));
            
            /// <summary>教课经验:[Enum-{:不限},{1:1年以下},{2:2-5年},{3:10年以上}]</summary>
            public static AttributeItem Teach_exp =  new AttributeItem("[V_teacher_user].[Teach_exp]", typeof(int), 4, default(int));
            
            /// <summary>教学模式:[Enum-{:不限},{1:在线1v1},{2:线下朋友团},{3:1v3小班},{4:1v5小班}]</summary>
            public static AttributeItem Teacher_mode =  new AttributeItem("[V_teacher_user].[Teacher_mode]", typeof(int), 4, default(int));
            
            /// <summary>服务方式:[Enum-{:不限},{1:仅首次上门},{2:上门服务},{3:在线答疑},{4:在线课}]</summary>
            public static AttributeItem Service_type =  new AttributeItem("[V_teacher_user].[Service_type]", typeof(int), 4, default(int));
            
            /// <summary>性别:[Enum-{:不限},{1:男老师},{2:女老师}]</summary>
            public static AttributeItem Sex =  new AttributeItem("[V_teacher_user].[Sex]", typeof(int), 4, default(int));
            
            /// <summary>科目:[Enum-{:不限},{1:数学},{2:英语},{3:语文},{4:物理},{5:化学},{6:生物},{7:政治},{8:历史},{9:地理},{10:奥数},{11:科学},{12:钢琴},{13:书法},{14:舞蹈},{15:素描},{16:国画}]</summary>
            public static AttributeItem Kemu =  new AttributeItem("[V_teacher_user].[Kemu]", typeof(string), 50, default(string));
            
            /// <summary></summary>
            public static AttributeItem City_id =  new AttributeItem("[V_teacher_user].[City_id]", typeof(string), 50, default(string));
            
            /// <summary>是否推荐简历</summary>
            public static AttributeItem Is_recommend =  new AttributeItem("[V_teacher_user].[Is_recommend]", typeof(bool), 1, default(bool));
            
            /// <summary>是否有过成交</summary>
            public static AttributeItem Is_done =  new AttributeItem("[V_teacher_user].[Is_done]", typeof(bool), 1, default(bool));
            
            /// <summary>排序权重</summary>
            public static AttributeItem Score_seq =  new AttributeItem("[V_teacher_user].[Score_seq]", typeof(double), 8, default(double));
            
            /// <summary></summary>
            public static AttributeItem Type =  new AttributeItem("[V_teacher_user].[Type]", typeof(bool), 1, default(bool));
            
            /// <summary>二维码</summary>
            public static AttributeItem E_wei_ma =  new AttributeItem("[V_teacher_user].[E_wei_ma]", typeof(string), 200, default(string));
            
            /// <summary>年级:[Enum-{0:不限},{1:一年级},{2:二年级},{3:三年级},{4:四年级},{5:五年级},{6:六年级},{7:七年级},{8:八年级},{9:九年级},{10:高一},{11:高二},{12:高三},{13:大一},{14:大二},{15:大三}]</summary>
            public static AttributeItem Grade =  new AttributeItem("[V_teacher_user].[Grade]", typeof(int), 4, default(int));
            
            /// <summary>年级:[Enum-{0:不限},{1:一年级},{2:二年级},{3:三年级},{4:四年级},{5:五年级},{6:六年级},{7:七年级},{8:八年级},{9:九年级},{10:高一},{11:高二},{12:高三},{13:大一},{14:大二},{15:大三}]</summary>
            public static AttributeItem Grade1 =  new AttributeItem("[V_teacher_user].[Grade1]", typeof(int), 4, default(int));
            
            /// <summary>年级:[Enum-{0:不限},{1:一年级},{2:二年级},{3:三年级},{4:四年级},{5:五年级},{6:六年级},{7:七年级},{8:八年级},{9:九年级},{10:高一},{11:高二},{12:高三},{13:大一},{14:大二},{15:大三}]</summary>
            public static AttributeItem Grade2 =  new AttributeItem("[V_teacher_user].[Grade2]", typeof(int), 4, default(int));
            
            /// <summary></summary>
            public static AttributeItem Xuebapingyu =  new AttributeItem("[V_teacher_user].[Xuebapingyu]", typeof(string), 2000, default(string));
            
            /// <summary></summary>
            public static AttributeItem Weizhi =  new AttributeItem("[V_teacher_user].[Weizhi]", typeof(string), 2000, default(string));
            
            /// <summary></summary>
            public static AttributeItem QQnum =  new AttributeItem("[V_teacher_user].[QQnum]", typeof(string), 2000, default(string));
            
            /// <summary></summary>
            public static AttributeItem ShujiaTime =  new AttributeItem("[V_teacher_user].[ShujiaTime]", typeof(string), 2000, default(string));
            
            /// <summary></summary>
            public static AttributeItem Good_kemu =  new AttributeItem("[V_teacher_user].[Good_kemu]", typeof(string), 2000, default(string));
            
            /// <summary></summary>
            public static AttributeItem Good_nianji =  new AttributeItem("[V_teacher_user].[Good_nianji]", typeof(string), 2000, default(string));
            
            /// <summary></summary>
            public static AttributeItem Ke_jieshou_kaishiTime =  new AttributeItem("[V_teacher_user].[Ke_jieshou_kaishiTime]", typeof(string), 2000, default(string));
            
            /// <summary></summary>
            public static AttributeItem Ke_jieshou_jiesuTime =  new AttributeItem("[V_teacher_user].[Ke_jieshou_jiesuTime]", typeof(string), 2000, default(string));
            
            /// <summary></summary>
            public static AttributeItem User_id =  new AttributeItem("[V_teacher_user].[User_id]", typeof(string), 36, default(string));
        }
        #endregion
        #region bool清单 辅助设计
        ...
        public static V_teacher_user FromIView(IView view)
        {
            return (V_teacher_user)IView.GetITable(view, "V_teacher_user");
        }
        /// <summary>获得一个实例  </summary>
        public static V_teacher_user GetOneInstance()
        {
            V_teacher_user value = new V_teacher_user();
            return value;
        }
        /// <summary>获取单一实例==BLLTable.GetRowData(); </summary>
        public V_teacher_user Retrieve()
        {
            BLLTable<V_teacher_user>.GetRowData(this);
            return this;
        }
        #endregion
        ...
        public override AttributeItem[] af_GetAvailableAttributeItem(ref List<object> values)
        {
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Expr1;
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Teacher_uuid;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Jiaoyuan_category;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Pay_jine;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Pay_keshi;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Pay_category;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (uuid_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.Uuid;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (id_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.Id;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Experience_year;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.College;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.College_major;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Work_field;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Recommend;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Voice;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Introduce;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Introduce_en;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Photo;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_head_img;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Score_high_school;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Score_mianshi1;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Score_mianshi2;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Score_mianshi3;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Score_mianshi;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Teacher_name_en;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Teacher_name;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Jin_sex;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Phone_number;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (born_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.Born;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.High_school;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Good_at;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Experience;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Experience_intro;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Work_area;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Home_area;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Other_area;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Create_time;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_nick_name;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_sex;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_country;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_province;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_city;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (f26_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.F26;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (f27_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.F27;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.OpenID;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_create_man;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_post_time;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_modify_time;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_device;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_os;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Wx_explore;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (ip_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.IP;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Is_show;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.On_top;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.On_top_timeout;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Time_match_ids;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Has_time_match_ids;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Today_match_ids;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Has_today_match_ids;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Catelog;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Teacher_type;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.English_kemu;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Teach_exp;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Teacher_mode;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Service_type;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (sex_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.Sex;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (kemu_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.Kemu;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.City_id;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Is_recommend;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Is_done;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Score_seq;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (type_initialized)
			{
                AttributeItem attr = V_teacher_user.Attribute.Type;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.E_wei_ma;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Grade;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Grade1;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Grade2;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Xuebapingyu;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Weizhi;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.QQnum;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.ShujiaTime;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Good_kemu;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Good_nianji;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Ke_jieshou_kaishiTime;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.Ke_jieshou_jiesuTime;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = V_teacher_user.Attribute.User_id;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
        ...
        /// </summary>
        [Serializable]
        public class V_teacher_userJson
        {
