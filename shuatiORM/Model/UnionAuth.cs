...
{
    /// <summary>
    /// <para>公共权限表-用户信息集成-unionid</para>
    ...
    public class UnionAuth : ITableImplement
    {
        ...
        /// <summary> 来源类型:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 来源类型:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        public int SourceId
        {
        ...
        public class Attribute
        {
            ...
            /// <summary>来源类型:[CtrlTypeDic-{InputString}]</summary>
