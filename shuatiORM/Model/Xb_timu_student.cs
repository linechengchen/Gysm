/************************************************************
  ...
  Author:               Created Time: 2017/6/20 23:47:31
  Description:    数据表Xb_timu_student对应的业务逻辑层Xb_timu_student
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Xb_timu_student_Entity:Xb_timu_student
 * 
************************************************************/
/************************************************************
SQL代码：
select Analysis,Answer,AnswerABC,Area,AutoId,ChapterId,ChapterName,Difficulty,DiggDown,DiggUp,ExamType,Explain,FalseCount,Grade,IsRepeatTf,KaoDian,Kemu,Kemu_name,Knowledge,Label,LinkExam,MediaContent,MediaHeight,MediaType,MediaWidth,OptionA,OptionB,OptionC,OptionD,OptionE,OptionF,OptionG,OptionH,Optionnum,OptionStr,OptionType,OrderId,PaperShortName,Photo,Question,QuestionId,QuestionIndex,Sc,Score,SourceFile,Sourceid,SourceZhangjie,Student_id,Teacher,TrueCount,Url,User_id,Uuid,WrongRate,YearId from Xb_timu_student
delete from Xb_timu_student
INSERT INTO Xb_timu_student (Analysis,Answer,AnswerABC,Area,AutoId,ChapterId,ChapterName,Difficulty,DiggDown,DiggUp,ExamType,Explain,FalseCount,Grade,IsRepeatTf,KaoDian,Kemu,Kemu_name,Knowledge,Label,LinkExam,MediaContent,MediaHeight,MediaType,MediaWidth,OptionA,OptionB,OptionC,OptionD,OptionE,OptionF,OptionG,OptionH,Optionnum,OptionStr,OptionType,OrderId,PaperShortName,Photo,Question,QuestionId,QuestionIndex,Sc,Score,SourceFile,Sourceid,SourceZhangjie,Student_id,Teacher,TrueCount,Url,User_id,Uuid,WrongRate,YearId)
     VALUES
           ('','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','')
UPDATE Xb_timu_student SET ...
变量赋值代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para></para>
    /// <para>与Xb_timu_student数据表对应的实体对象。</para>
    /// <para>增加一个数据列的方法是：在"类字段"节增加一个bool标识位，与"Attribute"属性 </para>
    /// </summary>    
    [Serializable]
    public class Xb_timu_student : ITableImplement
    {
        /// <summary>工厂方法  </summary>
        public static Xb_timu_student Factory()
        {
            return new Xb_timu_student();
        }
        ...
        /// <summary> 答案:[CtrlTypeDic-{HTML}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 选项内容:[CtrlTypeDic-{HTML}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 拍照:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 问题:[CtrlTypeDic-{HTML}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 题号（顺序号）:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 创建人id:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 答案:[CtrlTypeDic-{HTML}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 选项内容:[CtrlTypeDic-{HTML}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 拍照:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        public string Photo
        {
        ...
        /// <summary> 问题:[CtrlTypeDic-{HTML}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 题号（顺序号）:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 创建人id:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        public class Attribute
        {
            ...
            public static AttributeItem Analysis =  new AttributeItem("[Xb_timu_student].[Analysis]", typeof(string), 50, default(string));
            
            /// <summary>答案:[CtrlTypeDic-{HTML}]</summary>
            public static AttributeItem Answer =  new AttributeItem("[Xb_timu_student].[Answer]", typeof(string), 3000, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem AnswerABC =  new AttributeItem("[Xb_timu_student].[AnswerABC]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Area =  new AttributeItem("[Xb_timu_student].[Area]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem AutoId =  new AttributeItem("[Xb_timu_student].[AutoId]", typeof(int), 4, default(int));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ChapterId =  new AttributeItem("[Xb_timu_student].[ChapterId]", typeof(string), 30, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ChapterName =  new AttributeItem("[Xb_timu_student].[ChapterName]", typeof(string), 100, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Difficulty =  new AttributeItem("[Xb_timu_student].[Difficulty]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem DiggDown =  new AttributeItem("[Xb_timu_student].[DiggDown]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem DiggUp =  new AttributeItem("[Xb_timu_student].[DiggUp]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem ExamType =  new AttributeItem("[Xb_timu_student].[ExamType]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{HTML}]</summary>
            public static AttributeItem Explain =  new AttributeItem("[Xb_timu_student].[Explain]", typeof(string), 2000, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem FalseCount =  new AttributeItem("[Xb_timu_student].[FalseCount]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Grade =  new AttributeItem("[Xb_timu_student].[Grade]", typeof(int), 4, default(int));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem IsRepeatTf =  new AttributeItem("[Xb_timu_student].[IsRepeatTf]", typeof(int), 4, default(int));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem KaoDian =  new AttributeItem("[Xb_timu_student].[KaoDian]", typeof(string), 200, default(string));
            ...
            public static AttributeItem Kemu =  new AttributeItem("[Xb_timu_student].[Kemu]", typeof(int), 4, default(int));
            
            /// <summary>科目名:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Kemu_name =  new AttributeItem("[Xb_timu_student].[Kemu_name]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Knowledge =  new AttributeItem("[Xb_timu_student].[Knowledge]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Label =  new AttributeItem("[Xb_timu_student].[Label]", typeof(string), 100, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem LinkExam =  new AttributeItem("[Xb_timu_student].[LinkExam]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaContent =  new AttributeItem("[Xb_timu_student].[MediaContent]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaHeight =  new AttributeItem("[Xb_timu_student].[MediaHeight]", typeof(string), 100, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaType =  new AttributeItem("[Xb_timu_student].[MediaType]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaWidth =  new AttributeItem("[Xb_timu_student].[MediaWidth]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionA =  new AttributeItem("[Xb_timu_student].[OptionA]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionB =  new AttributeItem("[Xb_timu_student].[OptionB]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionC =  new AttributeItem("[Xb_timu_student].[OptionC]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionD =  new AttributeItem("[Xb_timu_student].[OptionD]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionE =  new AttributeItem("[Xb_timu_student].[OptionE]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionF =  new AttributeItem("[Xb_timu_student].[OptionF]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionG =  new AttributeItem("[Xb_timu_student].[OptionG]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionH =  new AttributeItem("[Xb_timu_student].[OptionH]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Optionnum =  new AttributeItem("[Xb_timu_student].[Optionnum]", typeof(string), 200, default(string));
            
            /// <summary>选项内容:[CtrlTypeDic-{HTML}]</summary>
            public static AttributeItem OptionStr =  new AttributeItem("[Xb_timu_student].[OptionStr]", typeof(string), 3000, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OptionType =  new AttributeItem("[Xb_timu_student].[OptionType]", typeof(string), 20, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem OrderId =  new AttributeItem("[Xb_timu_student].[OrderId]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem PaperShortName =  new AttributeItem("[Xb_timu_student].[PaperShortName]", typeof(string), 50, default(string));
            
            /// <summary>拍照:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Photo =  new AttributeItem("[Xb_timu_student].[Photo]", typeof(string), 250, default(string));
            
            /// <summary>问题:[CtrlTypeDic-{HTML}]</summary>
            public static AttributeItem Question =  new AttributeItem("[Xb_timu_student].[Question]", typeof(string), 3000, default(string));
            
            /// <summary>题号（顺序号）:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem QuestionId =  new AttributeItem("[Xb_timu_student].[QuestionId]", typeof(int), 4, default(int));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem QuestionIndex =  new AttributeItem("[Xb_timu_student].[QuestionIndex]", typeof(int), 4, default(int));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Sc =  new AttributeItem("[Xb_timu_student].[Sc]", typeof(string), 20, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Score =  new AttributeItem("[Xb_timu_student].[Score]", typeof(string), 10, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem SourceFile =  new AttributeItem("[Xb_timu_student].[SourceFile]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Sourceid =  new AttributeItem("[Xb_timu_student].[Sourceid]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem SourceZhangjie =  new AttributeItem("[Xb_timu_student].[SourceZhangjie]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Student_id =  new AttributeItem("[Xb_timu_student].[Student_id]", typeof(string), 36, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Teacher =  new AttributeItem("[Xb_timu_student].[Teacher]", typeof(string), 50, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem TrueCount =  new AttributeItem("[Xb_timu_student].[TrueCount]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Url =  new AttributeItem("[Xb_timu_student].[Url]", typeof(string), 200, default(string));
            
            /// <summary>创建人id:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem User_id =  new AttributeItem("[Xb_timu_student].[User_id]", typeof(string), 36, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Uuid =  new AttributeItem("[Xb_timu_student].[Uuid]", typeof(string), 36, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem WrongRate =  new AttributeItem("[Xb_timu_student].[WrongRate]", typeof(string), 200, default(string));
            
            /// <summary>[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem YearId =  new AttributeItem("[Xb_timu_student].[YearId]", typeof(string), 50, default(string));
        }
        #endregion
        #region bool清单 辅助设计
        ...
        /// <summary></summary>
        public new Xb_timu_student Clone()
        {
            return (Xb_timu_student)this.MemberwiseClone(); //浅复制
        }
        #endregion
        
        #region 构造函数 获得实例
        /// <summary>构造函数  </summary>
        static Xb_timu_student()
        {
            //if (InitRunTime.IsInitRunTime) InitRunTime.IsInitRunTime = true;
        }
        /// <summary>构造函数  </summary>
        public Xb_timu_student() { }
        /// <summary>
        /// 是否载入所有属性  
        /// </summary>
        /// <param name="IsLoadAllAttributes">是否全部初始化为true</param>
        public Xb_timu_student(bool IsLoadAllAttributes):base(IsLoadAllAttributes) { }
        /// <summary>实现分表功能，修改表名  </summary>
        //public Xb_timu_student(string tableName):base(tableName) { }
        /// <summary>实现分表功能，自定义实例的初始化  </summary>
        //public Xb_timu_student(string tableName, params AttributeItem[] attrs) : base(tableName, attrs) { }
        /// <summary>实现快捷功能  </summary>
        //public Xb_timu_student(params AttributeItem[] attrs) : base(attrs) { }
        
        /// <summary>请注意，这里当表中仅存在一个字段的时候，将可能与构造函数 new Table(string tableName)冲突  </summary>
        public Xb_timu_student(string analysis1, string answer1, string answerabc1, string area1, int autoid1, string chapterid1, string chaptername1, string difficulty1, string diggdown1, string diggup1, string examtype1, string explain1, string falsecount1, int grade1, int isrepeattf1, string kaodian1, int kemu1, string kemu_name1, string knowledge1, string label1, string linkexam1, string mediacontent1, string mediaheight1, string mediatype1, string mediawidth1, string optiona1, string optionb1, string optionc1, string optiond1, string optione1, string optionf1, string optiong1, string optionh1, string optionnum1, string optionstr1, string optiontype1, string orderid1, string papershortname1, string photo1, string question1, int questionid1, int questionindex1, string sc1, string score1, string sourcefile1, string sourceid1, string sourcezhangjie1, string student_id1, string teacher1, string truecount1, string url1, string user_id1, string uuid1, string wrongrate1, string yearid1)
        {
        ...
        public static Xb_timu_student FromIView(IView view)
        {
            return (Xb_timu_student)IView.GetITable(view, "Xb_timu_student");
        }
        /// <summary>获得一个实例  </summary>
        public static Xb_timu_student GetOneInstance()
        {
            Xb_timu_student value = new Xb_timu_student();
            return value;
        }
        /// <summary>获取单一实例==BLLTable.GetRowData(); </summary>
        public Xb_timu_student Retrieve()
        {
            BLLTable<Xb_timu_student>.GetRowData(this);
            return this;
        }
        #endregion
        ...
        public override bool SetValue(AttributeItem AttributeName,object AttributeValue)
        {
			...
			{				
			    ...
			    case "Uuid":
			        this.Uuid = Convert.ToString(AttributeValue);
                    return true;
        ...
        public override AttributeItem[] af_GetAvailableAttributeItem(ref List<object> values)
        {
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Analysis;
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Answer;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.AnswerABC;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (area_initialized)
			{
                AttributeItem attr = Xb_timu_student.Attribute.Area;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.AutoId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.ChapterId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.ChapterName;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Difficulty;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.DiggDown;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.DiggUp;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.ExamType;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Explain;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.FalseCount;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Grade;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.IsRepeatTf;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.KaoDian;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (kemu_initialized)
			{
                AttributeItem attr = Xb_timu_student.Attribute.Kemu;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Kemu_name;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Knowledge;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Label;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.LinkExam;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.MediaContent;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.MediaHeight;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.MediaType;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.MediaWidth;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionA;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionB;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionC;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionD;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionE;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionF;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionG;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionH;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Optionnum;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionStr;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OptionType;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.OrderId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.PaperShortName;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Photo;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Question;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.QuestionId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.QuestionIndex;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (sc_initialized)
			{
                AttributeItem attr = Xb_timu_student.Attribute.Sc;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Score;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.SourceFile;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Sourceid;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.SourceZhangjie;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Student_id;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.Teacher;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.TrueCount;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (url_initialized)
			{
                AttributeItem attr = Xb_timu_student.Attribute.Url;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.User_id;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			if (uuid_initialized)
			{
                AttributeItem attr = Xb_timu_student.Attribute.Uuid;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.WrongRate;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
			...
			{
                AttributeItem attr = Xb_timu_student.Attribute.YearId;
                if(!af_IsCondition || !Runtime_PersistenceLayer.IsInTbColumnCannotConditions(attr))
                {
                    parametersList.Add(attr);
                    if(values != null)
        ...
        /// </summary>
        [Serializable]
        public class Xb_timu_studentJson
        {
