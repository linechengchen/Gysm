/************************************************************
  ...
  Author:               Created Time: 2017/6/20 22:53:44
...
{
    /// <summary>
    /// <para>大学题库:[Inner-{St_TTimuDaXue:0}]</para>
    ...
    public class Del_VTimuDaXue : ITableImplement
    {
        ...
        /// <summary> 源大学微信号 Attribute_IsNotNull </summary>
        public string _Sc
        {            
            get { return this.Sc; }
            set { this.Sc = value; }
        ...
        /// <summary> 源大学微信号，推荐使用 "_"符号开头 </summary>
        public string Sc
        {
        ...
        public class Attribute
        {
            ...
            public static AttributeItem ChapterId =  new AttributeItem("[Del_VTimuDaXue].[ChapterId]", typeof(string), 30, default(string));
            ...
            public static AttributeItem Explain =  new AttributeItem("[Del_VTimuDaXue].[Explain]", typeof(string), 2000, default(string));
            
            /// <summary>章节:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Label =  new AttributeItem("[Del_VTimuDaXue].[Label]", typeof(string), 100, default(string));
            
            /// <summary>媒体高度:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem MediaHeight =  new AttributeItem("[Del_VTimuDaXue].[MediaHeight]", typeof(string), 100, default(string));
            ...
            public static AttributeItem OptionType =  new AttributeItem("[Del_VTimuDaXue].[OptionType]", typeof(string), 20, default(string));
            
            /// <summary>题目:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Question =  new AttributeItem("[Del_VTimuDaXue].[Question]", typeof(string), -1, default(string));
            ...
            public static AttributeItem IsRepeatTf =  new AttributeItem("[Del_VTimuDaXue].[IsRepeatTf]", typeof(int), 4, default(int));
            ...
            public static AttributeItem User_id =  new AttributeItem("[Del_VTimuDaXue].[User_id]", typeof(string), 36, default(string));
        }
        #endregion
        #region bool清单 辅助设计
