...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    ...
    public class Xb_product_type : ITableImplement
    {
        ...
        /// <summary> 编码（没用）:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        public int _Code
        {            
        ...
        /// <summary> 班级类型:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        public string _Type
        {            
        ...
        /// <summary> 编码（没用）:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        public int Code
        {
        ...
        /// <summary> 班级类型:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        public string Type
        {
        ...
        public class Attribute
        {
            ...
            /// <summary>编码（没用）:[CtrlTypeDic-{InputString}]</summary>
            ...
            /// <summary>班级类型:[CtrlTypeDic-{InputString}]</summary>
